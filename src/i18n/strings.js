...
const en = {
  ...
  'gameplay.acceptTask': 'View Case',
  'gameplay.acceptTask.aria': 'View case — see assignment details',
  'gameplay.assignmentModal.aria': 'Assignment details',
  'dialogue.you': 'You',
  'dialogue.next.aria': 'Next',
  'dialogue.close.aria': 'Close dialogue',
  'dialogue.playerFallback': "Got it. I'll take a look.",
...
const zh = {
  ...
  'gameplay.acceptTask': '查看案件',
  'gameplay.acceptTask.aria': '查看案件 · 任务说明',
  'gameplay.assignmentModal.aria': '任务说明',
  'dialogue.you': '你',
  'dialogue.next.aria': '下一句',
  'dialogue.close.aria': '关闭对话',
  'dialogue.playerFallback': '好的，我来看看。',
